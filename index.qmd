...
1.  Initial Data Exploration and Analysis
    ...
    3.  Buffer zones
2.  Data Extraction
    4.  Aggregate demand from bus stop data
    5.  OSM Road data
3.  Data Classification
    6.  Manual labelling of OSM road layers for network analysis
4.  Creation of analysis layers
    7.  Network analysis layer (QNEAT's Iso Areas) for each MRT station
    8.  Measuring demand from analysis
